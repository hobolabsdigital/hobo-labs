function e(e, t) {
	...
	function Ie(e, n, r) {
		if (U.bind(), s.uniform2f(U.uniforms.uMouseVelocity, t.mouseX || 0, t.mouseY || 0), s.uniform1f(U.uniforms.uAberration, t.ABERRATION_MULT || 0), t.SHADING && s.uniform2f(U.uniforms.texelSize, 1 / n, 1 / r), s.uniform1i(U.uniforms.uTexture, _.read.attach(0)), t.BLOOM) {
	...
	function Be(e) {
		...
		He(e.texcoordX, e.texcoordY, n, r, t.SPLAT_COLOR || e.color);
	}
	function Ve(e) {
		for (let n = 0; n < e; n++) {
			let e = Z();
